...
author: "Habitat Management for Forest Birds, by Claire Mann, January 21 2026"
date: "`r Sys.Date()`"
...
"C:\\Users\\pjs23\\Documents\\Projects\\CCE\\Webinar Data and Files\\webinar evaluation montly summary\\2025.data.attend.exit\\2025_10_slash wall panel\\meetinglistdetails_2025_10_15_participant_zoom.xlsx"
...
file_path_zoom <- "C:\\Users\\pjs23\\Documents\\Projects\\CCE\\Webinar Data and Files\\webinar evaluation montly summary\\2025.data.attend.exit\\2025_10_slash wall panel\\meetinglistdetails_2025_10_15_participant_zoom.xlsx"


#qualtrics included in the zoom file as a worksheet "qualtrics"
#file_path_qualtrics <- "C:\\Users\\pjs23\\Documents\\Projects\\CCE\\Webinar Data and Files\\webinar evaluation montly summary\\2026.data.attend.exit\\2026_01_bird_habitat_Mann\\2026_01_21_Mann_forest_bird_habitat_all_data.xlsx"

webinar_name <- "2025_October_slash_wall_voices" 

output_folder <- "C:\\Users\\pjs23\\Documents\\Projects\\CCE\\Webinar Data and Files\\webinar evaluation montly summary\\2025.data.attend.exit\\2025_10_slash wall panel"
...
input_zoom_attend <- read_excel(file_path_zoom, sheet = "full_cleaned", skip = 9) %>%
  filter(!(duration=="x")) %>% 
    mutate(email = tolower(email))

#input_zoom_register<- read_excel(file_path_zoom, sheet = "registration", skip = 9) %>% 
#mutate(email = tolower(email))

input_zoom <- input_zoom_attend %>% 
    
#due to data glitch, there are no acres in the zoom file.    
...
input_qualtrics <- read_excel(file_path_zoom, sheet = "qualtrics", skip = 9) %>% 
...
[webinar archived at] https://youtu.be/i0lw39iBVr4
<!-- Create summary of General Comments -->
