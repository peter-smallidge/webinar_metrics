...
# a. name the worksheet "full_cleaned" for attendee data and "registration" for registration data. Manually condense users with multiple entries.
# b. retain attended and those who didn't attend
# c. remove the day/month/year (or see the code for "str_remove")
# d. use these as variables: 
#   - registration (skip 5):  first	last	email	time	approval	country	zip	state	perspective	ceu	acres	notifications
#   - attended (skip 1):  name	email	join	leave	duration
...
file_path_registration <- "C:\\Users\\pjs23\\Documents\\Projects\\CCE\\Webinar Data and Files\\webinar evaluation montly summary\\2025.data.attend.exit\\2025_05_21_sap\\2025_may_21_registration.xlsx"

file_path_attendee <- "C:\\Users\\pjs23\\Documents\\Projects\\CCE\\Webinar Data and Files\\webinar evaluation montly summary\\2025.data.attend.exit\\2025_05_21_sap\\2025_may_21_attendee_details.xlsx"


file_path_qualtrics <- "C:\\Users\\pjs23\\Documents\\Projects\\CCE\\Webinar Data and Files\\webinar evaluation montly summary\\2025.data.attend.exit\\2025_05_21_sap\\2025_05_21_qualtrics.xlsx"

webinar_name <- "2025_05_21_Moore_sap_alternate" 

output_folder <- "C:/Users/pjs23/Documents/Projects/CCE/Webinar Data and Files/webinar evaluation montly summary/2025.data.attend.exit/2025_05_21_sap"
...
input_registration <- read_excel(file_path_registration, sheet = "registration", skip = 6) %>%
  mutate(time2 = format(time, "%H:%M"))   
    
   mutate(join = parse_date_time(join, orders = "I:M:S p"),
      join = round_date(join, unit = "minute"),
      join = format(join, "%I:%M %p")) %>%   # reformat as hour:minute AM/PM
    
   mutate(leave = parse_date_time(leave, orders = "I:M:S p"),
      leave = round_date(leave, unit = "minute"),
      leave = format(leave, "%I:%M %p")) %>%   # reformat as hour:minute AM/PM
    #   #    
 ...
 input_attendee <- read_excel(file_path_attendee, sheet = "full_cleaned", skip = 0) %>%
...
[webinar archived at] https://youtu.be/XPZTAeAldIA
<!-- Create summary of General Comments -->
