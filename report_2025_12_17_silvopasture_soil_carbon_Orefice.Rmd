...
author: "Soil Carbon in Silvopasture, by Joseph Orefice 17 December 2025"
date: "`r Sys.Date()`"
...
file_path_zoom <- "C:/Users/pjs23/Documents/Projects/CCE/Webinar Data and Files/webinar evaluation montly summary/2025.data.attend.exit/2025_12_17_soil_carbon_Orefice/attendee_soil_carbon_2025_12_17.xlsx"


file_path_qualtrics <- "C:/Users/pjs23/Documents/Projects/CCE/Webinar Data and Files/webinar evaluation montly summary/2025.data.attend.exit/2025_12_17_soil_carbon_Orefice/qualtrics_soil_carbon_2025_12_17.xlsx"

webinar_name <- "2025_12_17_Silvopasture_Soil_Carbon_Orefice" 

output_folder <- "C:/Users/pjs23/Documents/Projects/CCE/Webinar Data and Files/webinar evaluation montly summary/2025.data.attend.exit/2025_12_17_soil_carbon_Orefice"
...
# IMPORTANT: In Excel, right click the join and leave columns, change format to numeric with 8 decimal places
...
# the following code from the "excel_time" function doesn't appear to be needed 
# if the "join" and "leave" are changed to "numeric with 8 decimals.
# 
  #   mutate(
  #   join  = as.numeric(join),   # Convert to numeric first
  #   leave = as.numeric(leave)   # Convert to numeric first
  # ) %>%
  #   
  # mutate(
  #   join  = excel_time_to_time(join),
  #   leave = excel_time_to_time(leave)
  # ) %>% 
    
  #     mutate(
  #   join  = as.POSIXct((as.numeric(join) * 86400), origin = "1899-12-30", tz = "America/New_York"),
  #   leave = as.POSIXct((as.numeric(leave) * 86400), origin = "1899-12-30", tz = "America/New_York")
  # ) %>%
  # mutate(
  #   join  = format(join, "%I:%M %p"),
  #   leave = format(leave, "%I:%M %p")
  # ) %>% 
...
[webinar archived at] https://youtu.be/dPvYk0luB0U
<!-- Create summary of General Comments -->
